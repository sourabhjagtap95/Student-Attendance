...
<meta charset="utf-8"> 
 ...
 {
    var date = document.teacher_registration.date;
    var month = document.teacher_registration.month;
    var year = document.teacher_registration.year;
    var flag=0;
    var username = document.teacher_registration.username;
    var firstname = document.teacher_registration.firstname;
    var lastname = document.teacher_registration.lastname;
    var password = document.teacher_registration.password;
    var confirm_password = document.teacher_registration.confirm_password;
    var email = document.teacher_registration.email;
    var mobile = document.teacher_registration.mobile;
...
<body onload="document.teacher_registration.firstname.focus();">
    <form name="teacher_registration" action="teacher_verify.php" method="post" onsubmit="return formValidation();">
    <div class="header">
        <div class="logo">
            <img src="mit_logo.png" class="logo"/>
        </div>
        <div class="main clearfix">
            <h1>SIGN UP FORM FOR TEACHERS</h1>
            <div class="box">
                <div class="form-element multi-field name" id="name">
                    ...
                    <fieldset>
                        <legend>
                            <strong>Unique Identification Number</strong>
                        </legend>
                        <label>
                            <input type="text" name="uid" id="text-fields" placeholder="Uid" required>
                        </label>
                    </fieldset>
                    <fieldset>
                        <legend>
